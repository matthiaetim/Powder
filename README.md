...
- **Fresh-Seite**: Meter, Laufzeit (unter einer Minute in Sekunden, sonst `1:34:07 Minuten`) und Durchschnittstempo des letzten Laufs, im Super-G Zeit, Tore und Durchschnittstempo ohne Strafzeit; Bestwert je Modus, Bestenliste (siehe unten), Moduswahl.
