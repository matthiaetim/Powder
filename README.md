...
- **Fresh-Seite**: Meter, Laufzeit (unter einer Minute in Sekunden, sonst `1:34:07 Minuten`) und Durchschnittstempo des letzten Laufs, im Super-G Zeit, Tore und Durchschnittstempo ohne Strafzeit; Bestwert je Modus, Bestenliste (siehe unten), Moduswahl: unter „Fresh“ steht der gewählte Modus mit Vorschau und Kurztext, ein Tipp darauf öffnet die Kachel „Modus“ mit allen Modi und dem eigenen Bestwert, ein Tipp auf eine Zeile wählt.
