...
- **Classic**: freie Abfahrt, so weit es geht. Mit einem Easter Egg, das nur selten und an wechselnden Stellen auftaucht (`src/yeti.js`, bewusst ohne Regler und ohne Debug-Anzeige).
